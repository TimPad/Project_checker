...
Создайте сценарий выступления в стиле {tone.lower()} как на TED сторителлинга с тремя частями:
1. "introduction": вступление с проблемой и названием проекта
2. "main_part": основная часть о целях, работе и новизне проекта  
3. "conclusion": заключение с итогами и значимостью
